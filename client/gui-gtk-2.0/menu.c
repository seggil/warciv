...
static const char *load_menu_game(void)
{
  ...
  GtkActionEntry entries_game[] = {
    ...
    {"GAME_SAVE_SETTINGS", GTK_STOCK_SAVE_AS, _("Sa_ve Settings"),
     ...
     G_CALLBACK(callback_game_save_settings)},
    ...
    {"GAME_SERVER_OPTIONS2", GTK_STOCK_PREFERENCES, _("Server Optio_ns"),
     NULL, _("Server Optio_ns"),
     G_CALLBACK(callback_game_server_options2)},
    {"GAME_SAVE_GAME", GTK_STOCK_SAVE_AS, _("_Save Game _As..."),
     NULL, _("_Save Game _As..."),
     G_CALLBACK(callback_game_save_game)},
    {"GAME_SAVE_QUICK", GTK_STOCK_SAVE, _("Save Game"),
     NULL, _("Save Game"),
     G_CALLBACK(callback_game_save_quick)},
    {"GAME_OUTPUT_LOG", GTK_STOCK_FILE, _("E_xport Log"),
     NULL, _("E_xport Log"),
     G_CALLBACK(callback_game_output_log)},
    {"GAME_CLEAR_OUTPUT", GTK_STOCK_CLEAR, _("Clear _Log"),
     NULL, _("Clear _Log"),
     G_CALLBACK(callback_game_clear_output)},
    ...
    {"GAME_LEAVE", GTK_STOCK_DISCONNECT, _("L_eave"),
     NULL, _("L_eave"),
     G_CALLBACK(callback_game_leave)},
    {"GAME_QUIT", GTK_STOCK_QUIT, _("_Quit"),
     NULL, _("_Quit"),
     G_CALLBACK(callback_game_quit)
    }
  };
...
static const char *load_menu_government(void)
{
  ...
  GtkActionEntry entries_government[] = {
    {"GOVERNMENT", NULL, _("Gov_ernment"), NULL, NULL,
     NULL},
    {"GOVERNMENT_TAX_RATE", NULL, _("_Tax Rates"),
     "<Shift>t", _("_Tax Rates"),
     G_CALLBACK(callback_government_tax_rate)},
    {"GOVERNMENT_FIND_CITY", NULL, _("_Find City"),
     "<Shift>f", _("_Find City"),
     G_CALLBACK(callback_government_find_city)},
    ...
    {"GOVERNMENT_CHANGE", NULL, _("_Change Government"), NULL, NULL,
     NULL
    },
  };
...
static const char *load_menu_view(void)
{
  ...
  GtkActionEntry entries_view[] = {
    {"VIEW", NULL, _("_View"), NULL, NULL,
     NULL},
    {"VIEW_IMPROVEMENTS", NULL, _("_Improvements"), NULL, NULL,
     NULL},
    {"VIEW_CENTER_VIEW", NULL, _("Center _View"),
     "c", _("Center _View"),
      G_CALLBACK(callback_view_center_view)},
    {"VIEW_TOGGLE_SELECTED_CITY_TRADEROUTES", NULL, _("Toggle Selected City Traderoutes"),
      "<Shift>q", _("Toggle Selected City Traderoutes"),
  ...
  GtkToggleActionEntry toggle_entries_view[] = {
    {"VIEW_SHOW_MAP_GRID", NULL, _("Map _Grid"),
     "<Control>g", _("Map _Grid"),
     G_CALLBACK(callback_view_show_map_grid), TRUE},
    ...
    {"VIEW_SHOW_TERRAIN", NULL, _("Te_rrain"),
     NULL, _("Te_rrain"),
     G_CALLBACK(callback_view_show_terrain), TRUE},
    {"VIEW_SHOW_COASTLINE", NULL, _("C_oastline"),
     NULL, _("C_oastline"),
     G_CALLBACK(callback_view_show_coastline), TRUE},
    ...
    {"VIEW_SHOW_IRRIGATION", NULL, _("_Irrigation"),
     NULL, _("_Irrigation"),
     G_CALLBACK(callback_view_show_irrigation), TRUE},
    {"VIEW_SHOW_MINES", NULL, _("_Mines"),
     NULL, _("_Mines"),
     G_CALLBACK(callback_view_show_mines), TRUE},
    ...
    {"VIEW_SHOW_SPECIALS", NULL, _("_Specials"), NULL,
     _("_Specials"),
     G_CALLBACK(callback_view_show_specials), TRUE},
    ...
    {"VIEW_SHOW_CITIES", NULL, _("C_ities"),
     NULL, _("C_ities"),
     G_CALLBACK(callback_view_show_cities), TRUE},
    {"VIEW_SHOW_UNITS", NULL, _("_Units"),
     NULL, _("_Units"),
     G_CALLBACK(callback_view_show_units), TRUE},
    {"VIEW_SHOW_FOCUS_UNIT", NULL, _("_Focus Unit"),
     NULL, _("_Focus Unit"),
     G_CALLBACK(callback_view_show_focus_unit), TRUE},
    {"VIEW_SHOW_FOG_OF_WAR", NULL, _("Fog of _War"),
     NULL, _("Fog of _War"),
     G_CALLBACK(callback_view_show_fog_of_war), TRUE
    }
  };
...
static const char *load_menu_order(void)
{
  ...
  GtkActionEntry entries_order[] = {
    {"ORDER", NULL, _("_Orders"), NULL, NULL,
     NULL},
    {"ORDER_BUILD_CITY", NULL, _("_Build City"),
     "b", _("_Build City"),
     G_CALLBACK(callback_order_build_city)},
    {"ORDER_ROAD", NULL, _("Build _Road"),
     "r", _("Build _Road"),
     G_CALLBACK(callback_order_road)},
    {"ORDER_IRRIGATE", NULL, _("Build _Irrigation"),
     "i", _("Build _Irrigation"),
     G_CALLBACK(callback_order_irrigate)},
    {"ORDER_MINE", NULL, _("Build _Mine"),
     "m", _("Build _Mine"),
     G_CALLBACK(callback_order_mine)},
    {"ORDER_TRANSFORM", NULL, _("Transf_orm Terrain"),
     "o", _("Transf_orm Terrain"),
     G_CALLBACK(callback_order_transform)},
    {"ORDER_FORTRESS", NULL, _("Build _Fortress"),
     "f", _("Build _Fortress"),
     G_CALLBACK(callback_order_fortress)},
    {"ORDER_AIRBASE", NULL, _("Build Airbas_e"),
     "e", _("Build Airbas_e"),
     G_CALLBACK(callback_order_airbase)},
    {"ORDER_POLLUTION", NULL, _("Clean _Pollution"),
     "p", _("Clean _Pollution"),
     G_CALLBACK(callback_order_pollution)},
    {"ORDER_FALLOUT", NULL, _("Clean _Nuclear Fallout"),
     "n", _("Clean _Nuclear Fallout"),
     G_CALLBACK(callback_order_fallout)},
    {"ORDER_SENTRY", NULL, _("_Sentry"),
     "s", _("_Sentry"),
     G_CALLBACK(callback_order_sentry)},
    {"ORDER_SLEEP", NULL, _("Sleep"),
     "k", _("Sleep"),
     G_CALLBACK(callback_order_sleep)},
    {"ORDER_PILLAGE", NULL, _("Pi_llage"),
     "<Shift>p", _("Pi_llage"),
     G_CALLBACK(callback_order_pillage)},
    {"ORDER_HOMECITY", NULL, _("Make _Homecity"),
     "h", _("Make _Homecity"),
     G_CALLBACK(callback_order_homecity)},
    {"ORDER_LOAD", NULL, _("_Load"),
     "l", _("_Load"),
     G_CALLBACK(callback_order_load)},
    {"ORDER_UNLOAD_TRANSPORTER", NULL, _("_Unload Transporter"),
     "<Shift>u", _("_Unload Transporter"),
     G_CALLBACK(callback_order_unload_transporter)},
    {"ORDER_UNLOAD", NULL, _("_Unload"),
     "u", _("_Unload"),
     G_CALLBACK(callback_order_unload)},
    {"ORDER_WAKEUP_OTHERS", NULL, _("Wake up o_thers"),
     "<Shift>w", _("Wake up o_thers"),
     G_CALLBACK(callback_order_wakeup_others)},
    {"ORDER_AUTO_SETTLER", NULL, _("_Auto Settler"),
     "a", _("_Auto Settler"),
     G_CALLBACK(callback_order_auto_settler)},
    {"ORDER_AUTO_EXPLORE", NULL, _("Auto E_xplore"),
     "x", _("Auto E_xplore"),
     G_CALLBACK(callback_order_auto_explore)},
    {"ORDER_CONNECT", NULL, _("_Connect"), NULL, NULL,
     NULL},
    {"ORDER_CONNECT_ROAD", NULL, _("Road"),
     "<Control>r", _("Road"),
     G_CALLBACK(callback_order_connect_road)},
    {"ORDER_CONNECT_RAIL", NULL, _("Rail"),
     "<Control>l", _("Rail"),
     G_CALLBACK(callback_order_connect_rail)},
    {"ORDER_CONNECT_IRRIGATE", NULL, _("Irrigate"),
     "<Control>i", _("Irrigate"),
     G_CALLBACK(callback_order_connect_irrigate)},
    {"ORDER_PATROL", NULL, _("Patrol (_Q)"),
     "q", _("Patrol (_Q)"),
     G_CALLBACK(callback_order_patrol)},
    {"ORDER_GOTO", NULL, _("_Go to"),
     "g", _("_Go to"),
     G_CALLBACK(callback_order_goto)},
    {"ORDER_GOTO_CITY", NULL, _("Go/_Airlift to City"),
     "<Shift>l", _("Go\\/_Airlift to City"),
     G_CALLBACK(callback_order_goto_city)},
    {"ORDER_RETURN", NULL, _("Ret_urn to nearest city"),
     "<Shift>g", _("Ret_urn to nearest city"),
     G_CALLBACK(callback_order_return)},
    {"ORDER_DISBAND", NULL, _("Disb_and Unit"),
     "<Shift>d", _("Disb_and Unit"),
     G_CALLBACK(callback_order_disband)},
    {"ORDER_DIPLOMAT_DLG", NULL, _("D_iplomat\\/Spy Actions"),
     "d", _("D_iplomat\\/Spy Actions"),
     G_CALLBACK(callback_order_diplomat_dlg)},
    {"ORDER_NUKE", NULL, _("Explode _Nuclear"),
     "<Shift>n", _("Explode _Nuclear"),
     G_CALLBACK(callback_order_nuke)},
    {"ORDER_WAIT", NULL, _("_Wait"),
     "w", _("_Wait"),
     G_CALLBACK(callback_order_wait)},
    {"ORDER_DONE", NULL, _("Don_e"),
     "space", _("Don_e"),
     G_CALLBACK(callback_order_done)
    }
  };
...
static const char *load_menu_delayed_goto(void)
{
  ...
  GtkActionEntry entries_delayed_goto[] = {
    {"DELAYED_GOTO", NULL, _("_Delayed Goto"), NULL, NULL,
     NULL},
    {"DELAYED_GOTO_DELAYED_GOTO", NULL, _("Delayed go_to"),
     "z", _("Delayed go_to"),
     G_CALLBACK(callback_delayed_goto_delayed_goto)},
    ...
    {"DELAYED_GOTO_AUTOMATIC", NULL, _("_Automatic execution"),
     NULL, NULL, NULL},
    {"DELAYED_GOTO_INCLUSIVE", NULL, _("_Inclusive filter"),
     NULL, NULL, NULL},
    {"DELAYED_GOTO_EXCLUSIVE", NULL, _("Exclusive filter"),
     NULL, NULL, NULL},
    {"DELAYED_GOTO_DG1", NULL, _("Delayed goto selection _1"),
     NULL, NULL, NULL},
    {"DELAYED_GOTO_DG1_SELECT", NULL, _("_Select"),
     "<Alt>1", _("_Select"),
     G_CALLBACK(callback_delayed_goto_dg1_select)},
    ...
    {"DELAYED_GOTO_DG1_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_delayed_goto_dg1_clear)},
    ...
    {"DELAYED_GOTO_DG2_SELECT", NULL, _("_Select"),
     "<Alt>2", _("_Select"),
     G_CALLBACK(callback_delayed_goto_dg2_select)},
    ...
    {"DELAYED_GOTO_DG2_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_delayed_goto_dg2_clear)},
    ...
    {"DELAYED_GOTO_DG3_SELECT", NULL, _("_Select"),
     "<Alt>3", _("_Select"),
     G_CALLBACK(callback_delayed_goto_dg3_select)},
    ...
    {"DELAYED_GOTO_DG3_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_delayed_goto_dg3_clear)},
  ...
  GtkToggleActionEntry toggle_entries_delayed_goto_inclusive[] = {
    {"DELAYED_GOTO_INCLUSIVE_ALL", NULL, _("_All units"),
     NULL, _("_All units"),
     G_CALLBACK(callback_delayed_goto_inclusive_all), TRUE},
    {"DELAYED_GOTO_INCLUSIVE_NEW", NULL, _("_New units"),
     NULL, _("_New units"),
     G_CALLBACK(callback_delayed_goto_inclusive_new), TRUE},
    ...
    {"DELAYED_GOTO_INCLUSIVE_OFF", NULL, _("_Off"),
     NULL, _("_Off"),
     G_CALLBACK(callback_delayed_goto_inclusive_off), TRUE}
  };

  GtkToggleActionEntry toggle_entries_delayed_goto_exclusive[] = {
    {"DELAYED_GOTO_EXCLUSIVE_ALL", NULL, _("_All units"),
     NULL, _("_All units"),
     G_CALLBACK(callback_delayed_goto_exclusive_all), TRUE},
    {"DELAYED_GOTO_EXCLUSIVE_NEW", NULL, _("_New units"),
     NULL, _("_New units"),
     G_CALLBACK(callback_delayed_goto_exclusive_new), TRUE},
    ...
    {"DELAYED_GOTO_EXCLUSIVE_OFF", NULL, _("_Off"),
     NULL, _("_Off"),
     G_CALLBACK(callback_delayed_goto_exclusive_off), TRUE}
  };
...
static const char *load_menu_airlift(void)
{
  ...
  GtkActionEntry entries_airlift[] = {
    ...
    {"AIRLIFT_AQ1", NULL, _("Airlift queue _4"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ1_SELECT", NULL, _("_Select"),
     "<Alt>4", _("_Select"),
     G_CALLBACK(callback_airlift_aq1_select)},
    ...
    {"AIRLIFT_AQ1_RECORD", NULL, _("_Record"),
     "<Control><Alt>4", _("_Record"),
     G_CALLBACK(callback_airlift_aq1_record)},
    {"AIRLIFT_AQ1_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_airlift_aq1_clear)},
    ...
    {"AIRLIFT_AQ1_SHOW", NULL, _("_Show"),
     NULL, _("_Show"),
     G_CALLBACK(callback_airlift_aq1_show)},
    {"AIRLIFT_AQ1_UNIT_TYPE", NULL, _("Airlift unit _type"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ2", NULL, _("Airlift queue _5"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ2_SELECT", NULL, _("_Select"),
     "<Alt>5", _("_Select"),
     G_CALLBACK(callback_airlift_aq2_select)},
    ...
    {"AIRLIFT_AQ2_RECORD", NULL, _("_Record"),
     "<Control><Alt>5", _("_Record"),
     G_CALLBACK(callback_airlift_aq2_record)},
    {"AIRLIFT_AQ2_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_airlift_aq2_clear)},
    ...
    {"AIRLIFT_AQ2_SHOW", NULL, _("_Show"),
     NULL, _("_Show"),
     G_CALLBACK(callback_airlift_aq2_show)},
    {"AIRLIFT_AQ2_UNIT_TYPE", NULL, _("Airlift unit _type"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ3", NULL, _("Airlift queue _6"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ3_SELECT", NULL, _("_Select"),
     "<Alt>6", _("_Select"),
     G_CALLBACK(callback_airlift_aq3_select)},
    ...
    {"AIRLIFT_AQ3_RECORD", NULL, _("_Record"),
     "<Control><Alt>6", _("_Record"),
     G_CALLBACK(callback_airlift_aq3_record)},
    {"AIRLIFT_AQ3_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_airlift_aq3_clear)},
    ...
    {"AIRLIFT_AQ3_SHOW", NULL, _("_Show"),
     NULL, _("_Show"),
     G_CALLBACK(callback_airlift_aq3_show)},
    {"AIRLIFT_AQ3_UNIT_TYPE", NULL, _("Airlift unit _type"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ4", NULL, _("Airlift queue _7"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ4_SELECT", NULL, _("_Select"),
     "<Alt>7", _("_Select"),
      G_CALLBACK(callback_airlift_aq4_select)},
    ...
    {"AIRLIFT_AQ4_RECORD", NULL, _("_Record"),
     "<Control><Alt>7", _("_Record"),
     G_CALLBACK(callback_airlift_aq4_record)},
    {"AIRLIFT_AQ4_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_airlift_aq4_clear)},
    ...
    {"AIRLIFT_AQ4_SHOW", NULL, _("_Show"),
     NULL, _("_Show"),
     G_CALLBACK(callback_airlift_aq4_show)},
    ...
    {"AIRLIFT_AQ5_SELECT", NULL, _("_Select"),
     "<Alt>8", _("_Select"),
     G_CALLBACK(callback_airlift_aq5_select)},
    ...
    {"AIRLIFT_AQ5_RECORD", NULL, _("_Record"),
     "<Control><Alt>8", _("_Record"),
     G_CALLBACK(callback_airlift_aq5_record)},
    {"AIRLIFT_AQ5_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_airlift_aq5_clear)},
    ...
    {"AIRLIFT_AQ5_SHOW", NULL, _("_Show"),
     NULL, _("_Show"),
     G_CALLBACK(callback_airlift_aq5_show)},
    {"AIRLIFT_AQ5_UNIT_TYPE", NULL, _("Airlift unit _type"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ6", NULL, _("Airlift queue _9"),
     NULL, NULL, NULL},
    {"AIRLIFT_AQ6_SELECT", NULL, _("_Select"),
     "<Alt>9", _("_Select"),
     G_CALLBACK(callback_airlift_aq6_select)},
    ...
    {"AIRLIFT_AQ6_RECORD", NULL, _("_Record"),
     "<Control><Alt>9", _("_Record"),
     G_CALLBACK(callback_airlift_aq6_record)},
    {"AIRLIFT_AQ6_CLEAR", NULL, _("_Clear"),
     NULL, _("_Clear"),
     G_CALLBACK(callback_airlift_aq6_clear)},
    ...
    {"AIRLIFT_AQ6_SHOW", NULL, _("_Show"),
     NULL, _("_Show"),
     G_CALLBACK(callback_airlift_aq6_show)},
    {"AIRLIFT_AQ6_UNIT_TYPE", NULL, _("Airlift unit _type"),
     NULL, NULL, NULL}
  };
...
static const char *load_menu_auto_caravan(void)
{
  ...
  GtkActionEntry entries_auto_caravan[] = {
    {"AUTO_CARAVAN", NULL, _("Auto _Caravan"),
     NULL, NULL, NULL},
...
static const char *load_menu_multi_selection(void)
{
  ...
  GtkActionEntry entries_multi_selection[] = {
    {"MULTI_SELECTION", NULL, _("_Multi-Selection"),
     NULL, NULL, NULL},
    ...
    {"MULTI_SELECTION_MS1_SELECT", NULL, _("_Select"),
     "1", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms1_select)},
    ...
    {"MULTI_SELECTION_MS2_SELECT", NULL, _("_Select"),
     "2", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms2_select)},
    ...
    {"MULTI_SELECTION_MS3_SELECT", NULL, _("_Select"),
     "3", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms3_select)},
    ...
    {"MULTI_SELECTION_MS4_SELECT", NULL, _("_Select"),
     "4", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms4_select)},
    ...
    {"MULTI_SELECTION_MS5_SELECT", NULL, _("_Select"),
     "5", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms5_select)},
    ...
    {"MULTI_SELECTION_MS6_SELECT", NULL, _("_Select"),
     "6", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms6_select)},
    ...
    {"MULTI_SELECTION_MS7_SELECT", NULL, _("_Select"),
     "7", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms7_select)},
    ...
    {"MULTI_SELECTION_MS8_SELECT", NULL, _("_Select"),
     "8", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms8_select)},
    ...
    {"MULTI_SELECTION_MS9_SELECT", NULL, _("_Select"),
     "9", _("_Select"),
     G_CALLBACK(callback_multi_selection_ms9_select)},
  ...
  GtkToggleActionEntry toggle_entries_multi_selection_inclusive[] = {
    ...
    {"MULTI_SELECTION_INCLUSIVE_OFF", NULL, _("_Off"),
     NULL, _("_Off"),
     G_CALLBACK(callback_multi_selection_inclusive_off), TRUE}
  ...
  GtkToggleActionEntry toggle_entries_multi_selection_exclusive[] = {
    ...
    {"MULTI_SELECTION_EXCLUSIVE_OFF", NULL, _("_Off"),
     NULL, _("_Off"),
     G_CALLBACK(callback_multi_selection_exclusive_off), TRUE}
  };
...
static const char *load_menu_miscellaneous(void)
{
  ...
  GtkActionEntry entries_miscellaneous[] = {
    {"MISCELLANEOUS", NULL, _("Misce_llaneous"),
     NULL, NULL, NULL},
  ...
  GtkToggleActionEntry toggle_entries_miscellaneous[] = {
    ...
    {"MISCELLANEOUS_TOGGLE_MOVEANDATTACK", NULL, _("Move and _attack mode"),
     "<Shift>o", _("Move and _attack mode"),
...
static const char *load_menu_help(void)
{
  ...
  GtkActionEntry entries_help[] = {
    ...
    {"HELP_LANGUAGES", NULL, _("Language_s"),
     NULL, _("Language_s"),
     G_CALLBACK(callback_help_languages)},
    {"HELP_CONNECTING", NULL, _("Co_nnecting"),
     NULL, _("Co_nnecting"),
     G_CALLBACK(callback_help_connecting)},
    {"HELP_CONTROLS", NULL, _("C_ontrols"),
     NULL, _("C_ontrols"),
     G_CALLBACK(callback_help_controls)},
    {"HELP_CHATLINE", NULL, _("C_hatline"),
     NULL, _("C_hatline"),
     G_CALLBACK(callback_help_chatline)},
    {"HELP_WORKLIST_EDITOR", NULL, _("_Worklist Editor"),
     NULL, _("_Worklist Editor"),
     G_CALLBACK(callback_help_worklist_editor)},
    {"HELP_CMA", NULL, _("Citizen _Management"),
     NULL, _("Citizen _Management"),
     G_CALLBACK(callback_help_cma)},
    {"HELP_PLAYING", NULL, _("_Playing"),
     NULL, _("_Playing"),
     G_CALLBACK(callback_help_playing)},
    {"HELP_WARCLIENT", NULL, _("_Warclient"),
     NULL, _("_Warclient - Warclient"),
     G_CALLBACK(callback_help_warclient)},
    {"HELP_IMPROVEMENTS", NULL, _("City _Improvements"),
     NULL, _("City _Improvements"),
     G_CALLBACK(callback_help_improvements)},
    {"HELP_UNITS", NULL, _("_Units"),
     NULL, _("_Units"),
     G_CALLBACK(callback_help_units)},
    {"HELP_COMBAT", NULL, _("Com_bat"),
     NULL, _("Com_bat"),
     G_CALLBACK(callback_help_combat)},
    {"HELP_ZOC", NULL, _("_ZOC"),
     NULL, _("_ZOC"),
     G_CALLBACK(callback_help_zoc)},
    {"HELP_TECH", NULL, _("Techno_logy"),
     NULL, _("Techno_logy"),
     G_CALLBACK(callback_help_tech)},
    {"HELP_TERRAIN", NULL, _("_Terrain"),
     NULL, _("_Terrain"),
     G_CALLBACK(callback_help_terrain)},
    {"HELP_WONDERS", NULL, _("Won_ders"),
     NULL, _("Won_ders"),
     G_CALLBACK(callback_help_wonders)},
    {"HELP_GOVERNMENT", NULL, _("_Government"),
     NULL, _("_Government"),
     G_CALLBACK(callback_help_government)},
    {"HELP_HAPPINESS", NULL, _("Happin_ess"),
     NULL, _("Happin_ess"),
     G_CALLBACK(callback_help_happiness)},
    {"HELP_SPACE_RACE", NULL, _("Space _Race"),
     NULL, _("Space _Race"),
     G_CALLBACK(callback_help_space_race)},
    {"HELP_COPYING", NULL, _("_Copying"),
     NULL, _("_Copying"),
     G_CALLBACK(callback_help_copying)},
    {"HELP_ABOUT", NULL, _("_About"),
     NULL, _("_About"),
     G_CALLBACK(callback_help_about)
    }
  };
