...
void blink_active_unit(void)
{
  ...
  if (punit_focus) {
	...
	{
		if(multi_select_blink||punit==punit_focus||unit_satisfies_filter(punit,multi_select_inclusive_filter,multi_select_exclusive_filter))
