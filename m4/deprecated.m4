...
AC_ARG_ENABLE(deprecate-gtk,
 AS_HELP_STRING([--enable-deprecate-gtk[=no/yes]],
                [turn off deprecate GTK [default=no]]),
 [case "${enableval}" in   
...
AC_ARG_ENABLE(deprecate-gdk,
 AS_HELP_STRING([--enable-deprecate-gdk[=no/yes]],
                [turn off deprecate GDK [default=no]]),
 [case "${enableval}" in   
...
AC_ARG_ENABLE(deprecate-gdk-pixbuf,
 AS_HELP_STRING([--enable-deprecate-gdk-pixbuf[=no/yes]],
                [turn off deprecate GDK PIXBUF [default=no]]),
 [case "${enableval}" in   
...
AC_ARG_ENABLE(deprecate-glib,
 AS_HELP_STRING([--enable-deprecate-glib[=no/yes]],
                [turn off deprecate glib [default=no]]),
 [case "${enableval}" in   
...
AC_ARG_ENABLE(deprecate-gtk-multihead-safe,
 AS_HELP_STRING([--enable-deprecate-gtk-multihead-safe[=no/yes]],
                [turn off deprecate GTK MULTIHEAD SAFE [default=no]]),
 [case "${enableval}" in   
...
AC_ARG_ENABLE(deprecate-gtk-enable-single-includes,
 AS_HELP_STRING([--enable-deprecate-gtk-enable-single-includes[=no/yes]],
                [turn off deprecate GTK ENABLE SINGLE INCLUDES[default=no]]),
 [case "${enableval}" in
...
AC_ARG_ENABLE(deprecate-gdk-pixbuf-enable-single-includes,
 AS_HELP_STRING([--enable-deprecate-gdk-pixbuf-enable-single-includes[=no/yes]],
                [turn off deprecate GDK PIXBUF ENABLE SINGLE INCLUDES[default=no]]),
 [case "${enableval}" in   
