...
AC_DEFUN([WARCIV_VERSION_COMMENT])

AC_DEFUN([WARCIV_VERSION_INFO],
[
  MAJOR_VERSION="$1"
  MINOR_VERSION="$2"
  PATCH_VERSION="$3"
...
AC_DEFUN([WARCIV_DEVEL_VERSION], [IS_DEVEL_VERSION="$1"])
AC_DEFUN([WARCIV_BETA_VERSION], [IS_BETA_VERSION="$1"])
