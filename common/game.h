...
enum game_outcomes {
  GAME_ENDED_NONE = 0,
  GAME_ENDED_DRAWN_BY_ENDYEAR,
  GAME_ENDED_DRAWN_BY_MUTUAL_DESTRUCTION,
  GAME_ENDED_BY_LONE_SURVIVAL,
  GAME_ENDED_BY_SPACESHIP,
  GAME_ENDED_BY_VOTE,
  GAME_ENDED_BY_TEAM_VICTORY,
  GAME_ENDED_BY_ALLIED_VICTORY,
